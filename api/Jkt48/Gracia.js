...
export default {
  name: "JKT48 Gracia",
  desc: "Kirim gambar random anggota JKT48 Gracia",
  category: "JKT48",
  path: "/jkt48/gracia?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Gracia dari JSON GitHub
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fgracia.json'
      ).then(r => r.data);
