...
export default {
  name: "JKT48 Marsha",
  desc: "Kirim gambar random anggota JKT48 Marsha",
  category: "JKT48",
  path: "/jkt48/marsha?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Marsha dari JSON
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fmarsha.json'
      ).then(r => r.data);
