...
export default {
  name: "JKT48 Christy",
  desc: "Kirim gambar random anggota JKT48 Christy",
  category: "JKT48",
  path: "/jkt48/christy?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Christy dari GitHub
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fchristy.json'
      ).then(r => r.data);
