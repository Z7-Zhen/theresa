...
export default {
  name: "JKT48 Michie",
  desc: "Kirim gambar random anggota JKT48 Michie",
  category: "JKT48",
  path: "/jkt48/michie?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Michie dari JSON GitHub
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fmichie.json'
      ).then(r => r.data);
