...
export default {
  name: "JKT48 Zee",
  desc: "Kirim gambar random anggota JKT48 Zee",
  category: "JKT48",
  path: "/jkt48/zee?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Zee dari JSON
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fzee.json'
      ).then(r => r.data);
