...
export default {
  name: "JKT48 Flora",
  desc: "Kirim gambar random anggota JKT48 Flora",
  category: "JKT48",
  path: "/jkt48/flora?apikey=",
  async run(req, res) {
    try {
      ...
      // Ambil list gambar Flora dari JSON GitHub
      const list = await axios.get(
        'https://raw.githubusercontent.com/Leoo7z/Image-Source/main/JKT48%2Fflora.json'
      ).then(r => r.data);
